...
if select == "HOME":
    ...
    with col2:
        st.image(Image.open(r"C:\Users\Hp\OneDrive\Desktop\python\images (3).jfif"),width= 450)
        st.image(Image.open(r"C:\Users\Hp\OneDrive\Desktop\python\images (2).jfif"),width= 450)
